...
def upgrade():
    ...
    op.create_foreign_key(
        "fk_labels_label_data_id_label_datas", "labels", "label_datas", ["label_data_id"], ["label_data_id"]
    )
...
def downgrade():
    ...
    op.execute(
        "ALTER TABLE label_datas ALTER COLUMN label_data_id SET DEFAULT nextval('label_datas_label_data_id_seq_downgrade')"
    )
