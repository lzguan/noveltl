...
def upgrade():
    ...
    op.create_foreign_key('fk_label_datas_label_group_id_label_groups', 'label_datas', 'label_groups', ['label_group_id'], ['label_group_id'])
    op.create_foreign_key('label_group_contributors_label_group_id_fkey', 'label_group_contributors', 'label_groups', ['label_group_id'], ['label_group_id'])
...
def downgrade():
    ...
    op.execute("ALTER TABLE label_groups ALTER COLUMN label_group_id SET DEFAULT nextval('label_groups_label_group_id_seq_downgrade')")
