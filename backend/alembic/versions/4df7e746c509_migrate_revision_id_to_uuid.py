...
def upgrade():
    ...
    op.create_foreign_key(
        "fk_revision_texts_revision_id_revisions", "revision_texts", "revisions", ["revision_id"], ["revision_id"]
    )

    op.create_unique_constraint(
        "uq_revision_text_version_per_revision", "revision_texts", ["revision_id", "revision_text_version"]
    )
...
def downgrade():
    ...
    op.execute(
        "ALTER TABLE revisions ALTER COLUMN revision_id SET DEFAULT nextval('revisions_revision_id_seq_downgrade')"
    )
