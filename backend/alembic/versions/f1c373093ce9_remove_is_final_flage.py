...
def upgrade():
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["revision_id"], ["revisions.revision_id"], name="fk_revision_texts_revision_id_revisions"
        ),
    ...
    op.create_unique_constraint(
        "uq_model_name_params", "auto_labels", ["revision_text_id", "auto_label_model_name", "auto_label_model_params"]
    )
    op.create_foreign_key(
        "fk_auto_labels_revision_text_id_revision_texts",
        "auto_labels",
        "revision_texts",
        ["revision_text_id"],
        ["revision_text_id"],
    ...
    op.create_foreign_key(
        "fk_label_datas_revision_text_id_revision_texts",
        "label_datas",
        "revision_texts",
        ["revision_text_id"],
        ["revision_text_id"],
