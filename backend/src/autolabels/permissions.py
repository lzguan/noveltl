...
def auto_label_mod_access_select[T: Select[tuple[Any, ...]]](q : T, current_user : User, aliased_type : type[AutoLabel] = AutoLabel) -> T:
    """
    ...
    """
    subq = select(1).where(
        aliased_type.chapter_content_id == novel_models.ChapterContent.chapter_content_id
