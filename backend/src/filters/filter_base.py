...
class Filter[
    FlagInstancesOptions: FlagInstancesOptionsBase,
    ...
    def get_contexts(
        self, db: Session, current_user: User, instances: list[Instance], options: GetContextsOptions
    ) -> list[Context | None]:
        """
    ...
    def decide_instances(
        ...
        db: Session,
        current_user: User,
        instance_contexts: list[tuple[Instance, Context | None]],
        options: DecideInstancesOptions,
    ) -> list[bool]:
        """
    ...
    def apply_filter(
        self, db: Session, current_user: User, instances: list[Instance], options: ApplyFilterOptions
    ) -> None:
        """
