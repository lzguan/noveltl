...
class RegisteredFilter(Protocol):
    ...
    def get_contexts(
        self, db: Session, current_user: User, instances: list[Any], options: Any
    ) -> Sequence[Context | None]: ...
    def decide_instances(
        self, db: Session, current_user: User, instance_contexts: list[tuple[Any, Any]], options: Any
    ) -> Sequence[bool]: ...
    def apply_filter(self, db: Session, current_user: User, instances: list[Any], options: Any) -> None: ...
