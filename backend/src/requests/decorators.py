...
def ttl_cache[**P, R: BaseModel](
    cache: TTLCache, ttl: int, success_code: int = 200, serialize_ret: Callable[[R], dict] | None = None
    ...
    def inner_decorator(func: Callable[P, R]) -> Callable[P, R]:
        ...
        def wrapper(
            ...
            **kwargs: P.kwargs,
            ...
            if not cache.insert(
                request_key, {"status": "pending", "status_code": None, "response": None, "error": None}, expire=ttl
            ):
                raise HTTPException(
                    status_code=409,
            ...
            try:
                ...
                cache.set(
                    request_key,
                    {
                        ...
                        "response": serialize_ret(result) if serialize_ret else None,
                        "error": None,
                    },
                    expire=ttl,
                )
                ...
                cache.set(
                    request_key,
                    {
                        ...
                        "response": None,
                        "error": {"detail": e.detail, "cacheConflict": False},
                    },
                    expire=ttl,
                )
                ...
                cache.set(
                    request_key,
                    {
                        ...
                        "status_code": 500,
                        "response": None,
                        "error": {"detail": str(e), "cacheConflict": False},
                    },
                    expire=ttl,
                )
                raise
