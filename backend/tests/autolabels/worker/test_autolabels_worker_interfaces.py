...
def test_chunk_blocks():
    separators = {".": SepPriority.HIGH, ",": SepPriority.MED, " ": SepPriority.LOW}
    ...
    expected_chunks2 = [("NoSeparatorsHere", 0, None)]
...
def test_chunk_text_basic():
    ...
    tokenizer2 = TokenizerTestWordsMerge()
    text2 = "the quick brown fox jumps over the lazy dog"
    separators2 = {".": SepPriority.HIGH, ",": SepPriority.MED}
...
def test_chunk_text_SepPriority():
    separators = {"\n": SepPriority.HIGH, ".": SepPriority.MED, ",": SepPriority.LOW}
...
def test_chunk_text_zero_token_infinite_loop():
    separators = {"\n": SepPriority.HIGH, ".": SepPriority.MED, ",": SepPriority.LOW, " ": SepPriority.LOW}
