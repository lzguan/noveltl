...
@pytest.fixture
def p1_revision_public(test_db: Session, p1_chapter_public: Chapter) -> Revision:
    """Public revision on a PUBLIC novel."""
    rev = Revision(
        chapter_id=p1_chapter_public.chapter_id,
        revision_text="Public chapter text.",
...
@pytest.fixture
def p1_revision_draft_on_public(test_db: Session, p1_chapter_public: Chapter) -> Revision:
    """Non-public draft revision on a PUBLIC novel."""
    rev = Revision(
        chapter_id=p1_chapter_public.chapter_id,
        revision_text="Draft text on public novel.",
...
@pytest.fixture
def p1_revision_restricted(test_db: Session, p1_chapter_restricted: Chapter) -> Revision:
    """Public revision on a RESTRICTED novel."""
    rev = Revision(
        chapter_id=p1_chapter_restricted.chapter_id,
        revision_text="Restricted novel text.",
...
@pytest.fixture
def p1_revision_private(test_db: Session, p1_chapter_private: Chapter) -> Revision:
    """Non-public revision on a PRIVATE novel."""
    rev = Revision(
        chapter_id=p1_chapter_private.chapter_id,
        revision_text="Private novel text.",
...
@pytest.fixture
def p1_revision_owner_editor(test_db: Session, p1_chapter_owner_editor: Chapter) -> Revision:
    """Non-public revision on the owner/editor novel."""
    rev = Revision(
        chapter_id=p1_chapter_owner_editor.chapter_id,
        revision_text="Owner-editor novel text.",
...
@pytest.fixture
def p1_revision_owner_viewer(test_db: Session, p1_chapter_owner_viewer: Chapter) -> Revision:
    """Non-public revision on the owner/viewer novel."""
    rev = Revision(
        chapter_id=p1_chapter_owner_viewer.chapter_id,
        revision_text="Owner-viewer novel text.",
