...
def p1_novel_public_tyrone(
    p1_language: Language, test_db: Session, p1_user_1: User, p1_source_work: SourceWork
) -> Novel:
    test_novel = Novel(
        novel_title="pt",
        ...
        source_work_id=p1_source_work.source_work_id,
    )
...
def p1_novel_public_speed(
    p1_language: Language, test_db: Session, p1_user_2: User, p1_source_work: SourceWork
) -> Novel:
    test_novel = Novel(
        novel_title="ps",
        language_code=p1_language.language_code,
...
def p1_novel_owner_editor(
    p1_language: Language, test_db: Session, p1_user_1: User, p1_user_2: User, p1_source_work: SourceWork
) -> Novel:
    test_novel = Novel(
        novel_title="oe",
        language_code=p1_language.language_code,
