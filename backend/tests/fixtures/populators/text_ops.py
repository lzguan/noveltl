...
def to_label_data_1(test_db: Session, to_label_group_1: LabelGroup, to_chapter_content: ChapterContent) -> LabelData:
    ld = LabelData(
        label_group_id=to_label_group_1.label_group_id, chapter_content_id=to_chapter_content.chapter_content_id
    )
    test_db.add(ld)
    test_db.commit()
    return ld
...
def to_label_data_2(test_db: Session, to_label_group_2: LabelGroup, to_chapter_content: ChapterContent) -> LabelData:
    ld = LabelData(
        label_group_id=to_label_group_2.label_group_id, chapter_content_id=to_chapter_content.chapter_content_id
    )
    test_db.add(ld)
    test_db.commit()
    return ld
