...
def test_chapters_query_permissions(
    ...
    rt = query_novel_by_id(test_db, p1_user_1, p1_novels['rt'].novel_id)
    rt_chapters = [insert_raw_chapter(test_db, p1_user_1, rt.novel_id, schemas.CreateRawChapter(
        raw_chapter_num=i
    )) for i in range(3)]
    rt_revisions = [insert_raw_chapter_revision(test_db, p1_user_1, chapter.raw_chapter_id, schemas.CreateRawChapterRevision(
        raw_chapter_revision_text=f"Text {chapter.raw_chapter_num}",
        raw_chapter_revision_title=f"Title {chapter.raw_chapter_num}")) for chapter in rt_chapters]
    
    with pytest.raises(NovelNotFoundException):
        query_raw_chapters_by_novel(test_db, p1_user_2, rt.novel_id, start=None, end=None)
    rt_chapters_u_admin = query_raw_chapters_by_novel(test_db, p1_admin, rt.novel_id, start=None, end=None)
    assert len(rt_chapters_u_admin) == 3
    rt_chapters_u_1 = query_raw_chapters_by_novel(test_db, p1_user_1, rt.novel_id, start=None, end=None)
    ...
    rt_revisions_u_admin = query_raw_chapter_revisions_by_novel(test_db, p1_admin, rt.novel_id, is_public=None, is_primary=None, is_final=None, start=None, end=None)
    assert len(rt_revisions_u_admin) == 3
    rt_revisions_u_1 = query_raw_chapter_revisions_by_novel(test_db, p1_user_1, rt.novel_id, is_public=None, is_primary=None, is_final=None, start=None, end=None)
    assert len(rt_revisions_u_1) == 3

    for revision in rt_revisions:
        with pytest.raises(RawChapterRevisionNotFoundException):
            query_raw_chapter_revision_by_id(test_db, p1_user_2, revision.raw_chapter_revision_id)
        rev_u_admin = query_raw_chapter_revision_by_id(test_db, p1_admin, revision.raw_chapter_revision_id)
        assert rev_u_admin.raw_chapter_revision_id == revision.raw_chapter_revision_id
        rev_u_1 = query_raw_chapter_revision_by_id(test_db, p1_user_1, revision.raw_chapter_revision_id)
        assert rev_u_1.raw_chapter_revision_id == revision.raw_chapter_revision_id

    oe = p1_novels['oe']
    oe_chapter_1 = insert_raw_chapter(test_db, p1_user_1, oe.novel_id, schemas.CreateRawChapter(
        raw_chapter_num=1
    ))
    oe_revision_1 = insert_raw_chapter_revision(test_db, p1_user_1, oe_chapter_1.raw_chapter_id, schemas.CreateRawChapterRevision(
    ...
    query_raw_chapter_revision_by_id(test_db, p1_user_1, oe_revision_1.raw_chapter_revision_id)
    assert len(query_raw_chapter_revisions_by_novel(test_db, p1_user_1, oe.novel_id, is_public=None, is_primary=None, is_final=None, start=None, end=None)) == 1

    query_raw_chapter_by_id(test_db, p1_user_2, oe_chapter_1.raw_chapter_id)
    query_raw_chapter_revision_by_id(test_db, p1_user_2, oe_revision_1.raw_chapter_revision_id)
    assert len(query_raw_chapter_revisions_by_novel(test_db, p1_user_2, oe.novel_id, is_public=None, is_primary=None, is_final=None, start=None, end=None)) == 1

    oe_chapter_2 = insert_raw_chapter(test_db, p1_user_2, oe.novel_id, schemas.CreateRawChapter(
        raw_chapter_num=2
    ))
    oe_revision_2 = insert_raw_chapter_revision(test_db, p1_user_2, oe_chapter_2.raw_chapter_id, schemas.CreateRawChapterRevision(
    ...
    query_raw_chapter_revision_by_id(test_db, p1_user_1, oe_revision_2.raw_chapter_revision_id)
    assert len(query_raw_chapter_revisions_by_novel(test_db, p1_user_1, oe.novel_id, is_public=None, is_primary=None, is_final=None, start=None, end=None)) == 2

    query_raw_chapter_by_id(test_db, p1_user_2, oe_chapter_2.raw_chapter_id)
    query_raw_chapter_revision_by_id(test_db, p1_user_2, oe_revision_2.raw_chapter_revision_id)
    assert len(query_raw_chapter_revisions_by_novel(test_db, p1_user_2, oe.novel_id, is_public=None, is_primary=None, is_final=None, start=None, end=None)) == 2
    ...
    with pytest.raises(RawChapterRevisionNotFoundException):
        query_raw_chapter_revision_by_id(test_db, None, oe_revision_1.raw_chapter_revision_id)
    ...
    query_raw_chapter_revision_by_id(test_db, p1_admin, oe_revision_1.raw_chapter_revision_id)

    ov = p1_novels['ov']
    ov_chapter_1 = insert_raw_chapter(test_db, p1_user_1, ov.novel_id, schemas.CreateRawChapter(
        raw_chapter_num=1
    ))
    ov_revision_1 = insert_raw_chapter_revision(test_db, p1_user_1, ov_chapter_1.raw_chapter_id, schemas.CreateRawChapterRevision(
    ...
    query_raw_chapter_revision_by_id(test_db, p1_user_2, ov_revision_1.raw_chapter_revision_id)
    with pytest.raises(NovelNotFoundException):
    ...
    with pytest.raises(RawChapterRevisionNotFoundException):
        query_raw_chapter_revision_by_id(test_db, None, ov_revision_1.raw_chapter_revision_id)
    
    # assert p1_user_2 cannot create chapters or revisions
    with pytest.raises(InsufficientPermissionsException):
        insert_raw_chapter(test_db, p1_user_2, ov.novel_id, schemas.CreateRawChapter(
            raw_chapter_num=2
        ))
    with pytest.raises(InsufficientPermissionsException):
        insert_raw_chapter_revision(test_db, p1_user_2, ov_chapter_1.raw_chapter_id, schemas.CreateRawChapterRevision(
    ...
    ov_chapter_2 = insert_raw_chapter(test_db, p1_admin, ov.novel_id, schemas.CreateRawChapter(
        raw_chapter_num=2
    ))
    ov_revision_2 = insert_raw_chapter_revision(test_db, p1_admin, ov_chapter_2.raw_chapter_id, schemas.CreateRawChapterRevision(
