...
class TestNovelBundleCreatesData:
    @pytest.mark.dependency(name="fixture_validation::novel_bundle")
    ...
    @pytest.mark.dependency(name="fixture_validation::novel_bundle_ids")
    ...
    @pytest.mark.dependency(name="fixture_validation::novel_bundle_relationships")
    ...
    @pytest.mark.dependency(name="fixture_validation::novel_bundle_content")
...
class TestLabelBundleCreatesData:
    @pytest.mark.dependency(name="fixture_validation::label_bundle")
    ...
    @pytest.mark.dependency(name="fixture_validation::label_bundle_non_empty")
    def test_labels_list_non_empty(self, label_bundle: LabelFixtureBundle) -> None:
        assert len(label_bundle.labels) > 0

    @pytest.mark.dependency(name="fixture_validation::label_bundle_relationships")
    ...
    @pytest.mark.dependency(name="fixture_validation::label_bundle_scores")
...
class TestChapterLoaderReturnsData:
    @pytest.mark.dependency(name="fixture_validation::chapter_loader")
...
class TestAutolabelLoaderReturnsData:
    @pytest.mark.dependency(name="fixture_validation::autolabel_loader")
