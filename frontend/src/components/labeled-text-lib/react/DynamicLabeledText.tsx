...
type EditorCallbacks<S extends Style, L extends StyledLabel<S>> = {
  onPointerDown?: ({
    ...
    manager,
    caret,
  }: CallbackParams<S, L, React.PointerEvent<HTMLDivElement>>) => void;
  onPointerMove?: ({
    event,
    manager,
    caret,
  ...
  onClick?: ({
    ...
    manager,
    caret,
  }: CallbackParams<S, L, React.MouseEvent<HTMLDivElement>>) => void;
  onDoubleClick?: ({
    event,
    manager,
    caret,
  ...
  onKeyDown?: ({
    ...
    manager,
    caret,
  }: CallbackParams<S, L, React.KeyboardEvent<HTMLDivElement>>) => void;
  onKeyUp?: ({
    event,
    manager,
    caret,
  ...
  onCopy?: ({
    ...
    manager,
    caret,
  }: CallbackParams<S, L, React.ClipboardEvent<HTMLDivElement>>) => void;
  onCut?: ({
    event,
    manager,
    caret,
  ...
  onCompositionStart?: ({
    ...
    manager,
    caret,
  }: CallbackParams<S, L, React.CompositionEvent<HTMLDivElement>>) => void;
  onCompositionUpdate?: ({
    event,
    manager,
    caret,
  ...
  onBeforeInput?: ({
    ...
    manager,
    caret,
  }: CallbackParams<S, L, React.InputEvent<HTMLDivElement>>) => void;
  onInput?: ({
    event,
    manager,
    caret,
  ...
  onFocus?: ({
    ...
    manager,
    caret,
  }: CallbackParams<S, L, React.FocusEvent<HTMLDivElement>>) => void;
  onBlur?: ({
    event,
    manager,
    caret,
