			...
			<section className="mx-auto flex w-full max-w-6xl flex-col gap-8 px-6 py-10">
				<header className="space-y-2">
					...
					<p className="max-w-3xl text-base text-muted-foreground">
						Browse source works and novels on the view side, or jump into the editing
						workspace when you are ready to work on chapter data.
					</p>
				</header>
				...
				<div className="grid gap-6 md:grid-cols-2">
					<Card>
						<CardHeader>
							...
							<CardDescription>
								Explore source works, novels, and their chapters. Search and filter
								by title.
							</CardDescription>
						</CardHeader>
					...
					<Card>
						<CardHeader>
							...
							<CardDescription>
								Work on chapter text, manage labels, and run automated tooling on
								your novels.
							</CardDescription>
						</CardHeader>
						<CardContent className="flex flex-wrap gap-3">
