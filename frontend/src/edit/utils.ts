...
export function resolveOffsetFromPoint(container: HTMLElement, clientX: number, clientY: number): number {
...
export function isRequestConflictErrorResponse(error: unknown): error is RequestConflictErrorResponse {
