...
4. To enable automated text labelling, run `docker compose --profile manual up -d autolabels-worker`.
...
4. To enable automated text labelling, run `docker compose --profile manual up -d autolabels-worker` in the local shell.
